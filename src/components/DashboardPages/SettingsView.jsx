        ...
        <div className="flex flex-col gap-3 p-6 border-b border-gray-100 w-full">
            <div className="flex items-center justify-between w-full">
                ...
                <Button 
                    ...
                    style={`px-4 py-2 text-sm rounded-lg font-medium transition-all ${
                        isOpen ? "bg-red-50 text-red-600 hover:bg-red-100" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                    }`}
...
export default function SettingsView() {
    ...
    return (
        // Conteneur principal qui centre tout au milieu de l'écran
        <div className="min-h-screen w-full flex flex-col items-center bg-gray-50 p-6">
            
            <div className="w-full max-w-4xl">
                <h1 className="mb-6 text-3xl font-bold text-gray-900 text-center md:text-left">
                    Votre compte - {prenom}
                </h1>
                
                {/* Le grand rectangle blanc contenant les paramètres */}
