            ...
            <div className="flex flex-col justify-center items-center p-8 bg-white rounded-2xl border border-gray-100 shadow-sm max-w-sm w-full mx-4">
                ...
                <div className="flex flex-col justify-center items-center mb-6">
                    <div className="text-blue-400 rounded-full bg-blue-50 p-4 mb-2">
                        <svg xmlns="logo" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8">
                ...
                {/* Bouton de redirection vers Register sans useNavigate */}
                <Link to="/Register">
                <button 
                    
                    className="text-sm font-medium text-blue-500 mt-2 hover:underline cursor-pointer bg-transparent border-none"
                >
                    Créer un compte
                </button>
